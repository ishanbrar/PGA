...
const CONTENT_MAPPING = {
  ...
  events: {
    ...
    pastEvents: {
      ...
      'events-past-event-1-title': 'Past Event 1 Title',
      'events-past-event-1-date': 'Past Event 1 Date',
      'events-past-event-1-location': 'Past Event 1 Location',
      'events-past-event-1-description': 'Past Event 1 Description',
      'events-past-event-1-highlights': 'Past Event 1 Highlights',
      'events-past-event-2-title': 'Past Event 2 Title',
      'events-past-event-2-date': 'Past Event 2 Date',
      'events-past-event-2-location': 'Past Event 2 Location',
      'events-past-event-2-description': 'Past Event 2 Description',
      'events-past-event-2-highlights': 'Past Event 2 Highlights',
      'events-past-event-3-title': 'Past Event 3 Title',
      'events-past-event-3-date': 'Past Event 3 Date',
      'events-past-event-3-location': 'Past Event 3 Location',
      'events-past-event-3-description': 'Past Event 3 Description',
      'events-past-event-3-highlights': 'Past Event 3 Highlights',
      'events-past-event-4-title': 'Past Event 4 Title',
      'events-past-event-4-date': 'Past Event 4 Date',
      'events-past-event-4-location': 'Past Event 4 Location',
      'events-past-event-4-description': 'Past Event 4 Description',
      'events-past-event-4-highlights': 'Past Event 4 Highlights',
      'events-past-event-5-title': 'Past Event 5 Title',
      'events-past-event-5-date': 'Past Event 5 Date',
      'events-past-event-5-location': 'Past Event 5 Location',
      'events-past-event-5-description': 'Past Event 5 Description',
      'events-past-event-5-highlights': 'Past Event 5 Highlights',
      'events-past-event-6-title': 'Past Event 6 Title',
      'events-past-event-6-date': 'Past Event 6 Date',
      'events-past-event-6-location': 'Past Event 6 Location',
      'events-past-event-6-description': 'Past Event 6 Description',
      'events-past-event-6-highlights': 'Past Event 6 Highlights'
    }
  },
  gallery: {
    hero: {
...
const getDefaultContent = (contentId) => {
  const defaults = {
    ...
    'events-past-event-1-highlights': 'Rajinder Singh - 1st Place, Priya Patel - 2nd Place, Amarjit Dhillon - 3rd Place, Perfect weather conditions, Record participation',
    ...
    'events-past-event-2-highlights': 'Traditional Punjabi Cuisine, Live Music Performance, Family Activities, Gift Exchange, Community Bonding',
    'events-past-event-3-title': 'Fall Charity Golf Outing',
    'events-past-event-3-date': 'November 20, 2023',
    'events-past-event-3-location': 'Prestonwood Golf Club',
    'events-past-event-3-description': 'Fall charity outing that raised significant funds for local community organizations.',
    'events-past-event-3-highlights': 'Charity Auction Success, Community Fundraising, Local Organization Support, Volunteer Recognition, Impact Report',
    'events-past-event-4-title': 'Golf Skills Workshop',
    'events-past-event-4-date': 'October 8, 2023',
    'events-past-event-4-location': 'Prestonwood Golf Club',
    'events-past-event-4-description': 'Educational workshop focused on improving golf skills and techniques.',
    'events-past-event-4-highlights': 'Professional Instruction, Video Analysis, Practice Drills, Course Management, Equipment Tips',
    'events-past-event-5-title': 'Summer Championship',
    'events-past-event-5-date': 'September 15, 2023',
    'events-past-event-5-location': 'Tribute Golf Links',
    'events-past-event-5-description': 'Summer championship tournament with record participation and exciting competition.',
    'events-past-event-5-highlights': 'Championship Format, Prize Distribution, Media Coverage, Sponsor Recognition, Player Interviews',
    'events-past-event-6-title': 'Community Mixer',
    'events-past-event-6-date': 'August 22, 2023',
    'events-past-event-6-location': 'Clubhouse',
    'events-past-event-6-description': 'Community networking event that strengthened bonds between club members.',
    'events-past-event-6-highlights': 'Cultural Celebration, Traditional Music, Family Activities, Community Awards, Networking Success',

    // Board of Directors defaults
    'board-president-name': 'John Doe',
    'board-president-email': 'dfwpunjabigolf@gmail.com',
    'board-president-phone': '469-406-7988',
    'board-president-bio': 'Experienced golf enthusiast with 15+ years in community leadership',
    'board-treasurer-name': 'Jane Smith',
    'board-treasurer-email': 'dfwpunjabigolf@gmail.com',
    'board-treasurer-phone': '469-406-7988',
    ...
    'board-tournament-director-email': 'dfwpunjabigolf@gmail.com',
    'board-tournament-director-phone': '469-406-7988',
